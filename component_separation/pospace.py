"""
This is merely a copy of the original pospace.py from MSC. It is copied due to submodule update issues when using github actions.
see 
https://github.com/actions/checkout/issues/116 or
...
try:
    from healpyhack import healpix_hack as hph
except:
    print("MSC: reverting to standard healpy")
